...
4. **Deep research** — dispatch research sub-agents for technical decisions that need latest industry practices
...
- Write the validated design (spec) to `docs/specs/yyyy-MM-dd-REQ-{id}/{topic}/design.md`
