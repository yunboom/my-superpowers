...
<HARD-GATE>
You MUST present ALL found directories as numbered options and WAIT for the user to choose before doing anything else. Do NOT load files, do NOT start writing the plan, do NOT proceed until the user selects.
